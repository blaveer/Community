                    ...
                    try:
                        ...
                        for ycjOne in ycj:
                            ...
                            try:
                                ...
                                #time.sleep(3)
                                try:
                                    options_select = WebDriverWait(driver, 20).until(lambda driver:driver.find_element_by_id("ComboLdDyNo"))  # 单元号
                                except:
                                    ...
                                    for option in options:
                                        ...
                                        try:
                                            floor = WebDriverWait(driver, 20).until(lambda driver:driver.find_elements_by_class_name("xfht-floor"))
                                        except:
                                            ...
                                            floorNum = len(floor)
                                            try:
                                                rooms = WebDriverWait(driver, 20).until(lambda driver:driver.find_elements_by_class_name("xhroom-xbox"))
                                            except:
                                                ...
                                                while room < roomNum:
                                                    ...
                                                    # 下面这部分先注释，不执行
                                                    try:
                                                        WebDriverWait(driver, 20).until(lambda driver:driver.switch_to.default_content())
                                                        WebDriverWait(driver, 20).until(lambda driver:driver.switch_to.frame("lhgfrm_FWDialog"))
                                                    except:
